...
export default function V2Page() {
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0a] text-white">
            ...
            <div className="pt-[72px] mx-auto max-w-[400px]">
                <main className="bg-[#222] rounded-[2.5rem] px-5 pt-8 pb-12 mx-2">
                    <h1 className="text-2xl font-extrabold text-center mb-8 tracking-tight">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        {/* Other tariffs — stacked vertically */}
